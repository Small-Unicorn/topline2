...
(function (global, factory) {
  ...
  var validate = function (value, _a) {
    var _b = (_a === void 0 ? {} : _a).locale; var locale = _b === void 0 ? '' : _b
  ...
  var validate$4 = function (value, _a) {
    var _b = _a === void 0 ? {} : _a; var min = _b.min; var max = _b.max
    if (Array.isArray(value)) {
  ...
  var validate$7 = function (files, _a) {
    var width = _a.width; var height = _a.height
    var list = []
  ...
  var validate$p = function (value, _a) {
    var target = _a.target; var values = _a.values
  ...
  ***************************************************************************** */
  ...
  function _validate (field, value, _a) {
    var _b = (_a === void 0 ? {} : _a).isInitial; var isInitial = _b === void 0 ? false : _b
    return __awaiter(this, void 0, void 0, function () {
  ...
  function createValidationCtx (ctx) {
    return __assign(__assign({}, ctx.flags), { errors: ctx.messages,
      classes: ctx.classes,
  ...
  function addListeners (vm, node) {
    ...
    var _a = createCommonHandlers(vm); var onInput = _a.onInput; var onBlur = _a.onBlur; var onValidate = _a.onValidate
  ...
  var ValidationProvider = Vue.extend({
    ...
    methods: {
      ...
      applyResult: function (_a) {
        var errors = _a.errors; var failedRules = _a.failedRules
  ...
  var ValidationObserver = Vue.extend({
    ...
    methods: {
      ...
      validate: function (_a) {
        var _b = (_a === void 0 ? {} : _a).silent; var silent = _b === void 0 ? false : _b
        return __awaiter(this, void 0, void 0, function () {
          var results
  ...
  function withValidation (component, mapProps) {
    ...
    hoc.render = function (h) {
      ...
      var _b = createCommonHandlers(this); var onInput = _b.onInput; var onBlur = _b.onBlur; var onValidate = _b.onValidate
  ...
  RulesAsList.forEach(function (_a) {
    var name = _a.name; var schema = _a.schema
    extend(name, schema)
  })
  // Install locale
  localize('en', en)
